  ...
  return (
    <footer className="bg-navy-radial text-white">
      <div className="container grid gap-10 py-14 lg:grid-cols-[1.35fr_1fr_1fr_1fr_1.2fr]">
        <div>
          <Logo dark />
          <p className="mt-5 max-w-sm text-sm leading-7 text-white/72">{siteConfig.tagline} We provide accessible, coordinated, and future-ready healthcare experiences.</p>
        ...
        <div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-3 flex gap-2">
              <Input placeholder="Enter your email" className="border-white/20 bg-white/10 text-white placeholder:text-white/55" />
      ...
      <div className="border-t border-white/10">
        <div className="container flex flex-col gap-3 py-5 text-sm text-white/62 md:flex-row md:items-center md:justify-between">
